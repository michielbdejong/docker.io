...
NOTE: this package has not been updated for a while; to work with the current latest versions of node and docker, please consider using dockerode instead.
